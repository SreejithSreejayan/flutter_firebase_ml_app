    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: <Widget>[
          ...
          Padding(padding: const EdgeInsets.all(16.0), child: Text(result)),
        ]),
      ),
      floatingActionButton: FancyFab(
        onFolderPressed: () async {
...
class _FancyFabState extends State<FancyFab>
  ...
  VoidCallback _onFolderPressed;
  VoidCallback _onCameraPressed;
  ...
  @override
  initState() {
    _onCameraPressed = widget.onCameraPressed;
    _onFolderPressed = widget.onFolderPressed;
